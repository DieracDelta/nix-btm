...
//
// - morally better option: expose a port on nix and dump this info so we don't have to strace it.
...
// as it stands right now, we'll just use strace and dtruss because they're easier
// This is worse because it involves elevated perms on both platforms
//
